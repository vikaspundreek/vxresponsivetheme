	...
	<div class="item_container_holder">
		...
		<div class="last">
				<ycommerce:testId code="Usergroup_Edit_button">
					<a href="${editUrl}" class="mycompany right pad_right edit"><spring:theme code="text.company.usergroup.edit.button" text="Edit"/></a>
				</ycommerce:testId>
			<c:if test="${fn:length(usergroup.members) > 0}">
				<a href="${disableUrl}">
					<ycommerce:testId code="Usergroup_Disable_button">
						<a href="${disableUrl}" class="mycompany right pad_right disable"><spring:theme code="text.company.usergroup.disable.button" text="Disable"/></a>
					</ycommerce:testId>
				</a>
			</c:if>
				<ycommerce:testId code="Usergroup_Remove_button">
					<a href="${removeUrl}" class="mycompany right pad_right remove"><spring:theme code="text.company.usergroup.remove.button" text="Remove"/></a>
				</ycommerce:testId>
		</div>
		<div class="item_container">
			...
			<div class="item_container_holder">
				...
				<div class="last">
					<a href="${membersUrl}" class="mycompany right pad_right create"><spring:theme code="text.company.usergroup.button.createnew" text="Edit"/></a>
				</div>
				<div class="item_container">
