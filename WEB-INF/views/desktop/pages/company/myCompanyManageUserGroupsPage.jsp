			...
			<div class="last">
				<a href="${createUserGroupUrl}">
					<ycommerce:testId code="Usergroup_createNew_button">
						<a href="${createUserGroupUrl}" class="mycompany right pad_right create"><spring:theme code="text.company.manageUsergroups.newUserGroupButton" text="Create New Usergroup"/></a>
					</ycommerce:testId>
				</a>
			</div>
