...
<template:page pageTitle="${pageTitle}">
	...
	<div class="span-20 last">
		...
		<div class="item_container_holder">
			...
			<div class="last">
				<a href="${editPermissionDetailsUrl}" class="mycompany right pad_right edit"><spring:theme code="text.company.costCenter.button.displayName" /></a>
				<c:choose>
					<c:when test="${permissionData.active}">
						<a href="${disableUrl}" class="mycompany right pad_right disable"><spring:theme code="text.company.budget.disableButton.displayName" /></a>
					</c:when>
					<c:otherwise>
						<a href="${enableUrl}" class="mycompany right pad_right enable"><spring:theme code="text.company.budget.enableButton.displayName" /></a>
					</c:otherwise>
				</c:choose>
			</div>
