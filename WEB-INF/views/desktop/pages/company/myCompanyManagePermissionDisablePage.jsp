		...
		<div class="item_container_holder">
			...
			<div class="item_container">
				...
				<div style="display: block; clear: both;">
					<a href="${cancelDisableUrl}" class="mycompany left no-confirm"><spring:theme code="text.company.managePermissions.disable.confirm.no"/></a>
					<form:form action="${confirmDisableUrl}">
						<button class="mycompany confirm"><spring:theme code="text.company.managePermissions.disable.confirm.yes"/></button>
					</form:form>
				</div>
			</div>
		</div>
