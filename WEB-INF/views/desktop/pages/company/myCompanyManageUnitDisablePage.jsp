				...
				<div class="item_container">
					...
					<div style="display: block; clear: both;">
						<form:form action="${disableUrl}">
							<a href="${cancelUrl}" class="mycompany form no-confirm"><spring:theme code="b2bunit.no.button" text="No"/></a>
							<button type="submit" class="mycompany form confirm"><spring:theme code="b2bunit.yes.button" text="Yes"/></button>
						</form:form>
					</div>
				</div>
			</div>
