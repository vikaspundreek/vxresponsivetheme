...
<div class="item_container_holder">
	...
	<div class="last">
		<a href="${editUrl}" class="mycompany right pad_right edit"><spring:theme code="text.company.manage.units.users.button.edit" text="Edit"/></a>
		<a href="${createUrl}&role=${role}" class="mycompany right pad_right create"><spring:theme code="text.company.manage.units.users.button.createnew" text="Create New"/></a>
	</div>
